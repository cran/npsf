...
{     glp_file *f;
      ...
      // (To pass CRAN check) else if (strcmp(name, "/dev/stdout") == 0)
      // (To pass CRAN check) {  flag |= IOSTD;
      // (To pass CRAN check) file = stdout;
      // (To pass CRAN check) }
      // (To pass CRAN check) else if (strcmp(name, "/dev/stderr") == 0)
      // (To pass CRAN check) {  flag |= IOSTD;
      // (To pass CRAN check) file = stderr;
      // (To pass CRAN check) }
      else
